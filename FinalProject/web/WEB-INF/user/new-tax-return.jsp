                ...
                <div class="border border">
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/taxreturn/new-tax-return">
                        <fieldset class="p-4">
                            ...
                            <input type="text" name="wage" <%--value="Wage"--%> placeholder="<fmt:message key="user.new.wage" bundle="${link}"/>" class="border p-3 w-100 my-2" required> <br>
                            <input type="text" name="militaryCollection" <%--value="militaryCollection"--%> placeholder="<fmt:message key="user.new.military" bundle="${link}"/>" class="border p-3 w-100 my-2" required> <br>
                            <input type="text" name="incomeTax" <%--value="incomeTax"--%> placeholder="<fmt:message key="user.new.income" bundle="${link}"/>" class="border p-3 w-100 my-2" required> <br>
