                        ...
                        <td class="w-25">
                                <span class="categories w-25 col1">
                                    <c:if test="${actionReport.getAction() eq 'EDIT'}"> <a class="nav-link nav-item"
                                      href="${pageContext.request.contextPath}/taxreturn/action-report-list/edit?editActionId=${actionReport.getReport_id()}"><fmt:message key="common.edit" bundle="${link}"/></a> </c:if>
                                </span>
                        </td>
                    </tr>
                </c:forEach>
