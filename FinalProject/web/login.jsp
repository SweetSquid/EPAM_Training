...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/webjars/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
                ...
                <div class="border">
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/taxreturn/login">
                        <fieldset class="p-4">
                            ...
                            <a class="mt-3 d-inline-block text-primary" href="${pageContext.request.contextPath}/taxreturn/registration">Register Now</a>
                        </fieldset>
                    </form>
                </div>
            </div>
